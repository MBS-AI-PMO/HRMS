<nav class="side-navbar">
    <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
                ...
                @can('core_hr')
                    ...
                    <li class="{{ request()->is('tickets*') ? 'active' : '' }}">
                        <a href="{{ route('tickets.index') }}"> <i
                                class="dripicons-ticket"></i><span>{{ __('Complaints') }}</span>
                        </a>
                    </li>
                @endcan
            ...
            @can('timesheet')
                <li
                    class="has-dropdown {{ request()->is('timesheet*') && !request()->is('timesheet/leaves*') ? 'active' : '' }}">
                    ...
                    <ul id="Timesheets" class="collapse list-unstyled ">
                        ...
                        @endcan
                        @can('view-holiday')
                            <li id="holiday"><a href="{{ route('holidays.index') }}">{{ __('Manage Holiday') }}</a>
                            </li>
                        @endcan
                        <li id="employee_activity_logs"><a
                                href="{{ route('employee_activity_logs.index') }}">{{ __('Employee Activity Logs') }}</a>
                        </li>
                    </ul>
                </li>
            @endcan
                ...
                if ($showLeaveManagementTabs) {
                    $pendingLeaveQuery = \App\Models\leave::query()
                        ...
                        ->where(function ($query) {
                            $query
                                ->whereDoesntHave('LeaveType', function ($wfhQuery) {
                                    $wfhQuery
                                        ->where('leave_type', 'like', '%wfh%')
            ...
            @can('payment-module')
                    <li class="has-dropdown {{ (request()->is('payroll*')) ? 'active' : '' }}">
                        ...
                        <ul id="Payroll" class="collapse list-unstyled ">
                            @can('view-payslip')
                                <li><a href="{{route('payroll.index')}}">{{__('Payroll Processing')}}</a>
                                </li>
                            @endcan
                            @can('view-paylist')
                                <li><a href="{{route('payment_history.index')}}">{{__('Processed Payroll')}}</a>
                                </li>
                            @endcan
                        </ul>
                    </li>
            ...
            <li class="has-dropdown {{ request()->is('report*') ? 'active' : '' }}"><a href="#HR_Reports"
                    aria-expanded="false" data-toggle="collapse">
                    <i class="dripicons-document"></i><span>{{ __('Reports') }}</span></a>
                <ul id="HR_Reports" class="collapse list-unstyled ">
                    ...
                    @can('report-employee')
                            ...
                            @can('report-employee')
                                <li id="employees_report"><a
                                            href="">{{__('Payrol Register')}}</a>
                                </li>
                            @endcan
                            @can('report-employee')
                                <li id="employees_report"><a
                                            href="">{{__('Salary Slips')}}</a>
                                </li>
                            @endcan
                            @can('report-employee')
                                <li id="employees_report"><a
