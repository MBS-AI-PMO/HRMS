                ...
                <div class="navbar-holder d-flex align-items-center justify-content-between">
                    ...
                    <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                        ...
                        @if (Auth::user()->role_users_id == 1)
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('help/index.html') }}" target="_blank"
                            ...
                            <a rel="nofollow" href="#" class="nav-link dropdown-item">
                                ...
                                @else
                                    @php
                                        ...
                                        if (empty($fullName)) {
                                            $fullName = $user->username ?? ($user->email ?? 'U');
                                        }
                                    ...
                                    <span class="profile-photo sm mr-1"
                                        style="
              width:32px;
              height:32px;
              min-width:32px;
                            ...
                            <ul id="employees" class="collapse list-unstyled ">
                                @can('view-details-employee')
                                    <li id="employee_list"><a
                                            href="{{ route('employees.index') }}">{{ __('Employee Lists') }}</a></li>
                                @endcan
                                @can('import-employee')
                                    <li id="user-import"><a
                    ...
                    <ul id="HR_Reports" class="collapse list-unstyled ">
                        ...
                        @can('report-pension')
                            <li id="pension_report"><a
                                    href="{{ route('report.pension') }}">{{ __('Pension Report') }}</a></li>
                        @endcan
                    </ul>
                </li>
                {{-- @endcan --}}
