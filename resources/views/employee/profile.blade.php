    ...
    {{ $initials }}
                        ...
                        <div class="tab-pane fade" id="WFH" role="tabpanel" aria-labelledby="wfh-tab">
                            ...
                            <p class="text-muted small mb-0">
                                {{ __('Work from home requests and approval status') }}
                            </p>
                            <hr>
...
<script type="text/javascript">
    ...
    $('#remove_profile_photo').click(function() {
        ...
        $.ajax({
            url: "{{ route('employees.removeProfilePhoto',$employee->id) }}",
            type: "POST",
            data: {
                _token: "{{ csrf_token() }}"
            },
...
<script>
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            ...
            let oldImage = document.getElementById('profile_photo_preview');
            let initials = document.getElementById('profile_photo_initials');
