...
class Asset extends Model
{
	...
	{
		$this->attributes['purchase_date'] = Carbon::createFromFormat(config('variable.date_format', 'd-m-Y'), $value)->format('Y-m-d');
	}
	...
	{
		$this->attributes['warranty_date'] = Carbon::createFromFormat(config('variable.date_format', 'd-m-Y'), $value)->format('Y-m-d');
	}
